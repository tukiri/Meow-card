...
/// The NekoBaseExpander direction
enum ExpanderDirection {
  /// Whether the [NekoBaseExpander] expands down
  down,

  /// Whether the [NekoBaseExpander] expands up
  up,
}

/// The [NekoBaseExpander] control lets you show or hide less important content
...
/// UI. The NekoBaseExpander can expand upwards or downwards.
///
...
///
/// ![NekoBaseExpander Preview](https://docs.microsoft.com/en-us/windows/apps/design/controls/images/NekoBaseExpander-default.gif)
///
/// See also:
///
///  * <https://docs.microsoft.com/en-us/windows/apps/design/controls/NekoBaseExpander>
class NekoBaseExpander extends StatefulWidget {
  /// Creates an NekoBaseExpander
  const NekoBaseExpander({
    Key? key,
    this.leading,
  ...
  /// The NekoBaseExpander header
  ///
  /// Usually a [Text]
  final Widget header;

  /// The NekoBaseExpander content
  ///
  /// You can use complex, interactive UI as the content of the
  /// NekoBaseExpander, including nested NekoBaseExpander controls in the content
  /// of a parent NekoBaseExpander as shown here.
  ///
  /// ![NekoBaseExpander Nested Content](https://docs.microsoft.com/en-us/windows/apps/design/controls/images/NekoBaseExpander-nested.png)
  ...
  /// The expand direction. Defaults to [NekoBaseExpanderDirection.down]
  final ExpanderDirection direction;

  /// Whether the [NekoBaseExpander] is initially expanded. Defaults to `false`
  ...
  @override
  NekoBaseExpanderState createState() => NekoBaseExpanderState();
}

class NekoBaseExpanderState extends State<NekoBaseExpander>
  ...
  void initState() {
    ...
    _open = PageStorage.of(context)?.readState(
      context,
      identifier: 'NekoBaseExpanderOpen',
    ) as bool? ??
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.only(
                  start: widget.trailing != null ? 4.0 : 20.0,
                  end: 4.0,
                  top:4.0,
                  bottom: 4.0
                ),
...
class NekoExpander extends StatefulWidget {
  ...
  @override
  NekoExpanderState createState() => NekoExpanderState();
}

class NekoExpanderState extends State<NekoExpander> {
  @override
  Widget build(BuildContext context) {
    return NekoBaseExpander(
      key:widget.listkey,
      ...
      headerShape:widget.headerShape,
    );
  }
}